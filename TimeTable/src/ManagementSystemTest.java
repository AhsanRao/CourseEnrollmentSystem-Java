...
public class ManagementSystemTest {
    ...
    public void setup() {
        ...
        // courses.add(new Course("Data mining", 120, "Year 3","Online", "Thursday","12:00", 2));
        // courses.add(new Course("Knowledge technologies", 240, "Year2","Face-to-face", "Friday", "14:00", 2));
        // courses.add(new Course("Algorithms and complexity", 240,"Year 2","Face-to-face", "Tuesday", "10:00", 1.5));
